<?php 
    ...
    $siswa = query ("SELECT siarota_siswa.nis_siswa, siarota_siswa.nama_siswa, siarota_siswa.alamat_siswa, 
    siarota_siswa.lahir_siswa, siarota_siswa.kelas, siarota_siswa.pwd_siswa, siarota_kelas.kd_kelas, 
    siarota_kelas.nama_kelas 
    FROM siarota_siswa 
    JOIN siarota_kelas ON siarota_kelas.kd_kelas = siarota_siswa.kelas 
    WHERE siarota_siswa.nis_siswa='$_SESSION[username]'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header fw-bold">
            ...
            ?>
            <i class="bi bi-file-person"></i>
            Profile <?= $row['nama_siswa'] ." - ". $row['nis_siswa']?>
            <?php
              endforeach;
            ?>
          </div>
