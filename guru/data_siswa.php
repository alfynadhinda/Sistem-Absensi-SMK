<?php 
    ...
    // $siswa = query ("SELECT siarota_siswa.`nis_siswa`, siarota_siswa.`nama_siswa`, siarota_siswa.`alamat_siswa`, siarota_siswa.`kelamin_siswa`, siarota_siswa.`lahir_siswa` 
    //                  FROM siarota_siswa 
