              ...
              <div class="modal-body">
                ...
                if(isset($_POST['submit'])){
                  if(tambah_mapel($_POST)>0){
                    ...
                    echo "
                    <script>
                    alert('Mata Pelajaran Gagal Berhasil Ditambahkan');
                ...
                <form action= "" method="POST">
                  <div class="mb-3">
                    <label for="kd_mapel" class="form-label">Kode Mata Pelajran</label>
                    <input type="text" class="form-control" id="kd_mapel" name="kd_mapel" aria-describedby="idmapel" placeholder="Kode Mata Pelajaran" required>
                  </div>
                  <div class="mb-3">
                    <label for="nama_mapel" class="form-label">Nama Mata Pelajaran</label>
                    <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" aria-describedby="namamapel" placeholder="Nama Mata Pelajaran">
                  </div>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="hapus_mapel.php?kd_mapel=<?= $row['kd_mapel']?>" type="button"  onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" class="btn btn-danger btn-sm">
