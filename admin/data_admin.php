<?php 
    ...
    // Melihat data
    $admin = mysqli_query($koneksi, "SELECT * FROM siarota_admin");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Data Admin | SMK NEGERI 1 ROTA BAYAT</title>
    <style>	
		body {
...
<body>
    ...
    <main class="mt-5 pt-4">
        <div class="container-fluid">
            <div class="row">
                <div class="col md-12 fw-bold fs-3 bi bi-person-fill-lock"> Data Admin</div>
            </div>
            <hr/>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            if(isset($_POST["submit"])){
                                ...
                                if (tambah_admin($_POST) >0) {
                                    ...
                                    document.location='data_admin.php?sukses';
                                    </script>";
                                }
                                else{
                                    echo "
                                    ...
                                    document.location='data_admin.php?gagal';
                                    </script>";
                                }
                            }
                            ?>
                            <form action="" method="post">
                                <div class="mb-3">
                                    <label for="nip" class="form-label">Kode Admin</label>
                                    <input type="text" class="form-control" id="nip" name="kd_admin" aria-describedby="kd_admin" placeholder="Kode Admin" required>
                                </div>
                                <div class="mb-3">
                                    <label for="username" class="form-label">Username</label>
                                    <input type="text" class="form-control" id="username_admin" name="username_admin" aria-describedby="username_admin" placeholder="Username" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="tlp_admin" class="form-label">No.Telepon</label>
                                    <input type="text" class="form-control" id="tlp_admin" name="tlp_admin" aria-describedby="telepon" placeholder="No.Telepon : 089-xxxx-xxxx" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Password</label>
                                    <input type="password" class="form-control" id="exampleInputPassword1"name="pwd_admin" required>
                                </div>
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <a href="edit_admin.php?kd_admin=<?= $row['kd_admin']?>" type="button" class="btn btn-warning btn-sm mb-1">
                        <i class="bi bi-pencil-square"></i>
                        Ubah
                        </a>
                        <a href="hapus_admin.php?kd_admin=<?= $row['kd_admin']?>" onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" type="button" class="btn btn-danger btn-sm">
