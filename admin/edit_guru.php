<?php 
    ...
    $nik = $_GET['nik_guru'];
    // Melihat data
    $data_guru = query("SELECT * FROM siarota_guru WHERE nik_guru = '$nik'")[0];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">Edit Data Guru <i class="bi bi-pencil-square"></i></div>
        ...
        ?>
          <form action="log_edit.php" method="POST">
            <div class="mb-1">
               ...
               <input type="text" class="form-control" id="nip" name="nik_guru" aria-describedby="nipguru" readonly value="<?= $data_guru['nik_guru']?>">
            </div>
            <div class="mb-1">
            ...
            <div class="mb-1">
              <label for="alamat_guru" class="form-label fw-bold fs-6">Alamat Lengkap</label>
              <input type="text" class="form-control" id="alamat_guru" name="alamat_guru" aria-describedby="alamat" value="<?= $data_guru['alamat_guru']?>">
            </div>
            <div class="mb-1">
              <label for="tlp_guru" class="form-label fw-bold fs-6">No.Telepon</label>
              <input type="text" class="form-control" id="tlp_guru" name="tlp_guru" aria-describedby="telepon" value="<?= $data_guru['tlp_guru']?>">
            </div>
            <div class="mb-1">
              <label for="exampleInputPassword1" class="form-label fw-bold fs-6">Password</label>
              <input type="password" class="form-control" id="exampleInputPassword1" name="pwd_guru" value="<?= $data_guru['pwd_guru']?>">
            </div>
