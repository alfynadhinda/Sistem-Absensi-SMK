                        ...
                        <div class="modal-body">
                            ...
                            if(isset($_POST["submit"])){
                                ...
                                if (tambah_guru($_POST) >0) {
                                    ...
                                    document.location='data_guru.php?sukses';
                                    </script>";
                                }
                                else{
                                    echo "
                                    ...
                                    document.location='data_guru.php?gagal';
                                    </script>";
                                }
                            }
                            ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nip" name="nik_guru" aria-describedby="nipguru" placeholder="Nomor Induk Pegawai" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alamat_guru" name="alamat_guru" aria-describedby="alamat" placeholder="Alamat Guru" required>
                            </div>
                            <div class="mb-3">
                                <label for="tlp_guru" class="form-label">No.Telepon</label>
                                <input type="text" class="form-control" id="tlp_guru" name="tlp_guru" aria-describedby="telepon" placeholder="No.Telepon : +6289-xxxx-xxxx" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Password</label>
                                <input type="password" class="form-control" id="exampleInputPassword1"name="pwd_guru" required>
                            </div>
                ...
                <tbody>
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            <a href="edit_guru.php?nik_guru=<?= $row['nik_guru']?>" type="button" class="btn btn-warning btn-sm mb-1">
                                <i class="bi bi-pencil-square"></i>
                                Ubah
                            </a>
                            <a href="hapus_data.php?nik_guru=<?= $row['nik_guru']?>" onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" type="button" class="btn btn-danger btn-sm">
