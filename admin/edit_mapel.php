<?php 
    ...
    $kod_mapel = $_GET['kd_mapel'];
    $data_mapel = query("SELECT * FROM siarota_mapel WHERE kd_mapel = '$kod_mapel'")[0];
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <form action="log_edit_mapel.php" method="POST">
            <div class="mb-1">
               <label for="kd_mapel" class="form-label mb-1 mt-1 fw-bold fs-6">Kode Matapelajaran</label>
               <input type="text" class="form-control" id="kd_mapel" name="kd_mapel" aria-describedby="kd_mapel" readonly value="<?= $data_mapel['kd_mapel']?>">
            </div>
            <div class="mb-1">
              <label for="nama_mapel" class="form-label fw-bold fs-6">Mata Pelajaran</label>
